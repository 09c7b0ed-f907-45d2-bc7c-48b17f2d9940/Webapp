  ...
  const bubble = (
    <div
      className={cn(
        ...
        isMe
          ? "bg-gradient-to-r from-primary to-accent text-primary-foreground rounded-3xl rounded-br-none dark:ring-1 ring-inset ring-white/40 dark:text-white"
          : isProgress
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            {buttons.map((btn, idx) => (
              <button
                ...
                className="px-3 py-1 text-xs font-medium rounded-full border border-current opacity-50 hover:opacity-100 transition-opacity"
              >
                {btn.title}
              </button>
            ))}
